      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul className="space-y-4">
            {[
              { title: 'Computer Systems Lab', desc: 'Exploring deep learning, neural networks, and applications of modern AI.' },
              { title: 'Neuroscience', desc: 'Investigating neuroplasticity, cognitive behaviors, and neurological structures.' },
              { title: 'Quantum Physics/Optics', desc: 'Research into quantum entanglement, computing paradigms, and state simulations.' },
              { title: 'Biotechnology', desc: 'Applying technological methods to biological systems for novel solutions.' },
              { title: 'Engineering', desc: 'Designing and building innovative solutions across various engineering disciplines.' }
            ].map((lab) => (
